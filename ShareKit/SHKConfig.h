 ...
 */
#define SHKTwitterConsumerKey		@"K8MVPMdqJIgkjtx7uDuoQ"
#define SHKTwitterSecret			@"y82OJfcDSoFf6itT7jtgh6oyX6SPdTXzPKST6tU"
#define SHKTwitterCallbackUrl		@"http://alpascual.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"dakotapascual" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
